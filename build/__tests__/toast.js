...
describe('toastify', () => {
    ...
    it("Should be possible to configure the ToastContainer even when it's lazy mounted", () => {
        ...
        jest.runAllTimers();
        expect(document.querySelector(containerClass)).not.toBe(null);
        expect(document.querySelector(`.${RT_NAMESPACE}__toast-container--rtl`)).not.toBe(null);
        unmountLazyContainer();
    });
    ...
    describe('onChange event', () => {
        ...
        it('Should pass containerId as second arg if set', done => {
            mount(React.createElement(ToastContainer, { containerId: "foo" }));
    ...
    describe('update function', () => {
        ...
        it('Should be able to update a toast even when using multi containers', () => {
            const component = mount(React.createElement(React.Fragment, null,
                React.createElement(ToastContainer, { containerId: "first", enableMultiContainer: true }),
                React.createElement(ToastContainer, { containerId: "second", enableMultiContainer: true })));
