...
describe("ToastContainer", () => {
    it("Should bind event when mounted and unbind them when unmounted", () => {
        const component = mount(React.createElement(ToastContainer, null));
    ...
    it("Should be able to render a react element, a string, a number, a render props without crashing", () => {
        ...
        toast("coucou");
        toast(123);
        toast(React.createElement("div", null, "plop"));
        toast(() => React.createElement("div", null, "plop"));
        jest.runAllTimers();
    ...
    it("Should be able to display new toast on top", () => {
        ...
        mount(React.createElement(ToastContainer, { newestOnTop: true }));
        expect(Array.prototype.reverse).toHaveBeenCalled();
    });
    it("Toast options should supersede ToastContainer props", () => {
        const component = mount(React.createElement(ToastContainer, null));
        const CloseBtn = () => React.createElement("div", null, "Close");
        const fn = () => { };
        const desiredProps = {
            pauseOnHover: false,
            closeOnClick: false,
    ...
    it("Should pass closeToast function and type when using a custom CloseButton", () => {
        const component = mount(React.createElement(ToastContainer, null));
        const CloseBtn = () => React.createElement("div", null, "x");
        const Msg = () => React.createElement("div", null, "Plop");
        toast(React.createElement(Msg, null), {
    ...
    it("Should be able to disable the close button", () => {
        let component = mount(React.createElement(ToastContainer, null));
        toast("hello");
        jest.runAllTimers();
    ...
    it("Should use default CloseButton when toast option set to true and ToastContainer options is false", () => {
        ...
        let component = mount(React.createElement(ToastContainer, { closeButton: false }));
        toast("hello");
        jest.runAllTimers();
    ...
    it("Should use custom CloseButton when toast option set to true and ToastContainer options is custom", () => {
        // set closeButton to false to remove it by default
        const CloseBtn = () => React.createElement("div", null, "CUSTOM_BUTTON");
        let component = mount(React.createElement(ToastContainer, { closeButton: React.createElement(CloseBtn, null) }));
        toast("hello");
        jest.runAllTimers();
        // ensure that close button is NOT present by default
    ...
    it("Should merge className and style", () => {
        const component = mount(React.createElement(ToastContainer, { className: "foo", style: { background: "red" } }));
        toast("hello");
        jest.runAllTimers();
    ...
    it("Should support css-in-js rules", () => {
        ...
        const component = mount(React.createElement(ToastContainer, { className: className, style: { background: "red" } }));
        toast("hello");
        jest.runAllTimers();
    ...
    it("Should include only the style needed for a given position", () => {
        Object.keys(toast.POSITION).forEach(k => {
            const component = mount(React.createElement(ToastContainer, { position: toast.POSITION[k] }));
            const id = toast("test");
            jest.runAllTimers();
            expect(component.instance().collection[id].position).toBe(toast.POSITION[k]);
        });
    });
    describe("Multiple container support", () => {
        describe("Disabled", () => {
            it("Should render toasts in all container", () => {
                const toastContainerComponent1 = mount(React.createElement(ToastContainer, { enableMultiContainer: false }));
                const toastContainerComponent2 = mount(React.createElement(ToastContainer, null));
                const toastContainerComponent3 = mount(React.createElement(ToastContainer, { containerId: 1 }));
                toast("Toast 1");
        ...
        describe("Enabled", () => {
            describe("With containerId", () => {
                it("Should show only related toasts aka- same containerId and containerId", () => {
                    const toastContainerComponent1 = mount(React.createElement(ToastContainer, { containerId: 1, enableMultiContainer: true }));
                    const toastContainerComponent2 = mount(React.createElement(ToastContainer, { containerId: 2, enableMultiContainer: true }));
                ...
                it("Should not display unrelated toasts", () => {
                    const toastContainerComponent = mount(React.createElement(ToastContainer, { containerId: 1, enableMultiContainer: true }));
            ...
            describe("Has no containerId", () => {
                it("Should display toasts with no containerId", () => {
                    const toastContainerComponent = mount(React.createElement(ToastContainer, { enableMultiContainer: true }));
                    toast("Toast");
                    jest.runAllTimers();
    ...
    it("Should be able run toast even when document is not visible", () => {
        ...
        mount(React.createElement(ToastContainer, { pauseOnVisibilityChange: false }));
    ...
    it("Should throw an error if can't render a toast", () => {
        expect(() => {
            mount(React.createElement(ToastContainer, null));
            toast(false);
            jest.runAllTimers();
